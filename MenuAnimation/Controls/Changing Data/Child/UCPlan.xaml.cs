...
using Astmara6.Controls.Changing_Data.Child.UCPlans;
...
namespace Astmara6Con.Controls
{
    ...
    public partial class UCPlan : UserControl
    {
        ...
        private void SubDoctors(object sender, RoutedEventArgs e)
        {
            var subDoctors = new DialogForSubDoctors();
            subDoctors.ShowDialog();
